...
class MinimumTimeVisitingAllPoints {
    ...
    public int minTimeToVisitAllPoints2(int[][] points) {
        ...
        for (int i = 1; i < points.length; i++) {
            ...
            while ((endPoint[0] - startPoint[0] != 0) || (endPoint[1] - startPoint[1] != 0)) {
                if (endPoint[0] - startPoint[0] != 0) {
                    startPoint[0] = endPoint[0] > startPoint[0] ? startPoint[0] + 1 : startPoint[0] - 1;
                }
                if (endPoint[1] - startPoint[1] != 0) {
                    startPoint[1] = endPoint[1] > startPoint[1] ? startPoint[1] + 1 : startPoint[1] - 1;
                }
                count++;
            }
            startPoint = endPoint;
